    ...
    <main className="mx-auto max-w-6xl px-6 py-16">
      ...
      {success && (
        <div className="mb-6 rounded-[1.5rem] border border-border bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-sm text-muted">Em breve o studio entrará em contato para confirmar o horário.</p>
        </div>
      )}
      ...
      <div className="grid gap-8 md:grid-cols-[0.9fr,1.1fr]">
        ...
        <form action={handleCreatePublicBookingRequest} className="rounded-[2rem] border border-border bg-white p-8 shadow-sm">
          <input type="hidden" name="businessId" value={business.id} />
          <input type="hidden" name="returnTo" value={`/${business.slug}/agendar`} />
